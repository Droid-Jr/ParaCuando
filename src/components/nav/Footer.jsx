...
function Footer() { 
  return (
    <div className="lg:bg-Fondomd bg-Fondo bg-no-repeat bg-cover bg-center  flex items-center justify-center relative bottom-0 right-0 left-0 h-2/4 md:h-[488px]">
